...
**実装計画**:
- [ ] CSS疑似要素またはJavaScriptでの文字置換
- [ ] トグルボタンの追加（ツールバーまたはキーボードショートカット）
- [ ] 不可視文字の色・透明度調整（邪魔にならないデザイン）
- [ ] パフォーマンス最適化（大容量テキスト対応）

**技術候補**:
1. CSS `white-space` + 疑似要素アプローチ
2. JavaScript文字列置換 + リアルタイム更新
3. オーバーレイ要素での視覚化
